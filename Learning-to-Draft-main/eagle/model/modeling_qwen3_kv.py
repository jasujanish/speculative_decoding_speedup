...
HAS_LOSS_KWARGS = True
try:
    from transformers.utils import LossKwargs, auto_docstring, can_return_tuple, logging
except ImportError:
    HAS_LOSS_KWARGS = False
    from transformers.utils import logging

    class LossKwargs(TypedDict, total=False):
        """Compatibility fallback for older or newer Transformers versions."""

    def auto_docstring(*args, **kwargs):
        """Return a no-op decorator when auto_docstring is unavailable."""
    ...
    def can_return_tuple(obj):
        """Return the wrapped object unchanged when the helper is unavailable."""
        return obj
