...
5. Qwen8b, Supervised Learning, 10k timesteps of data, 50 epochs --> Nish
---
...
5. Qwen14b, Supervised Learning, 10k timesteps of data, 50 epochs --> Alistair
---
1. Qwen8b, LTD, 20k steps per phase, (co-optimized) --> Neil
2. Qwen8b, LTD, 20k steps per phase, (not co-optimized) --> Neil
3. Qwen8b, Supervised Learning, 20k timesteps of data, 1 epoch --> Neil
4. Qwen8b, Supervised Learning, 20k timesteps of data, 20 epochs --> Neil
5. Qwen8b, Supervised Learning, 20k timesteps of data, 50 epochs --> Neil
---
...
5. Qwen14b, Supervised Learning, 20k timesteps of data, 50 epochs --> Neil
---
1. Qwen8b, LTD, 50k steps per phase, (co-optimized) --> Neil
2. Qwen8b, LTD, 50k steps per phase, (not co-optimized) --> Neil
2. Qwen8b, Supervised Learning, 50k timesteps of data, 1 epoch --> Neil
3. Qwen8b, Supervised Learning, 50k timesteps of data, 20 epochs --> Neil
4. Qwen8b, Supervised Learning, 50k timesteps of data, 50 epochs --> Neil
---
1. Qwen14b, LTD, 50k steps per phase, (co-optimized) --> Neil
2. Qwen14b, LTD, 50k steps per phase, (not co-optimized) --> Neil
2. Qwen14b, Supervised Learning, 50k timesteps of data, 1 epoch --> Neil
3. Qwen14b, Supervised Learning, 50k timesteps of data, 20 epochs --> Neil
4. Qwen14b, Supervised Learning, 50k timesteps of data, 50 epochs --> Neil
---
1. Qwen8b, LTD, 100k steps per phase, (co-optimized) --> Alistair
2. Qwen8b, LTD, 100k steps per phase, (not co-optimized) --> Alistair
2. Qwen8b, Supervised Learning, 100k timesteps of data, 1 epoch --> Alistair
3. Qwen8b, Supervised Learning, 100k timesteps of data, 20 epochs --> Alistair
4. Qwen8b, Supervised Learning, 100k timesteps of data, 50 epochs --> Alistair
---
1. Qwen14b, LTD, 100k steps per phase, (co-optimized) --> Alistair
2. Qwen14b, LTD, 100k steps per phase, (not co-optimized) --> Alistair
2. Qwen14b, Supervised Learning, 100k timesteps of data, 1 epoch --> Alistair
3. Qwen14b, Supervised Learning, 100k timesteps of data, 20 epochs --> Alistair
4. Qwen14b, Supervised Learning, 100k timesteps of data, 50 epochs --> Alistair
